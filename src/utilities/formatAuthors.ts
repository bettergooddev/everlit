...
/**
 * Formats an array of populatedAuthors from Case Studies into a prettified string.
 * @param authors - The populatedAuthors array from a Case Study.
...
export const formatAuthors = (
  authors: NonNullable<NonNullable<CaseStudy['populatedAuthors']>[number]>[],
) => {
